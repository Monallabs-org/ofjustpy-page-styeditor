...
# we are switching to mutable_wrappers.ActiveJsonMixin
# completely for Passive and Active Components
...
class StaticCore(
    ...
    def __init__(self, *args, **kwargs):
        ...
        # we should probably use EmptyDict, or OneKeyDict
        # just like in core-engine/src/ofjustpy_engine/mutable_HC_TF.py
...
class HCCPassiveMixin(HCCStaticMixin):
    def __init__(self, *args, **kwargs):
        HCCStaticMixin.__init__(self, *args, **kwargs)
